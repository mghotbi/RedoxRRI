...
```
    ...
    ##   [4] otel_0.2.0            matrixStats_1.5.0     compiler_4.5.2       
    ##   [7] mgcv_1.9-3            systemfonts_1.3.2     vctrs_0.7.1          
    ##  [10] stringr_1.6.0         pkgconfig_2.0.3       fastmap_1.2.0        
    ##  [13] backports_1.5.0       labeling_0.4.3        rmarkdown_2.30       
    ##  [16] preprocessCore_1.72.0 ragg_1.5.1            xfun_0.56            
    ##  [19] cachem_1.1.0          jsonlite_2.0.0        flashClust_1.1-4     
    ##  [22] parallel_4.5.2        cluster_2.1.8.1       R6_2.6.1             
    ##  [25] bslib_0.10.0          stringi_1.8.7         RColorBrewer_1.1-3   
    ##  [28] compositions_2.0-9    rpart_4.1.24          jquerylib_0.1.4      
    ##  [31] estimability_1.5.1    Rcpp_1.1.1            iterators_1.0.14     
    ##  [34] knitr_1.51            WGCNA_1.74            base64enc_0.1-6      
    ##  [37] FNN_1.1.4.1           Matrix_1.7-4          splines_4.5.2        
    ##  [40] nnet_7.3-20           tidyselect_1.2.1      rstudioapi_0.18.0    
    ##  [43] yaml_2.3.12           viridis_0.6.5         doParallel_1.0.17    
    ...
    ##  [55] isoband_0.3.0         ggtern_4.0.0          bayesm_3.1-7         
    ##  [58] pillar_1.11.1         tensorA_0.36.2.1      checkmate_2.3.4      
    ##  [61] DT_0.34.0             foreach_1.5.2         generics_0.1.4       
    ##  [64] scales_1.4.0          leaps_3.2             glue_1.8.0           
    ##  [67] emmeans_2.0.2         scatterplot3d_0.3-45  Hmisc_5.2-5          
    ##  [70] tools_4.5.2           hexbin_1.28.5         robustbase_0.99-7    
    ##  [73] data.table_1.18.2.1   RSpectra_0.16-2       fs_1.6.7             
    ##  [76] mvtnorm_1.3-3         fastcluster_1.3.0     grid_4.5.2           
    ##  [79] impute_1.84.0         colorspace_2.1-2      nlme_3.1-168         
    ##  [82] htmlTable_2.4.3       proto_1.0.0           Formula_1.2-5        
    ##  [85] cli_3.6.5             latex2exp_0.9.8       textshaping_1.0.5    
    ##  [88] viridisLite_0.4.3     uwot_0.2.4            gtable_0.3.6         
    ##  [91] DEoptimR_1.1-4        dynamicTreeCut_1.63-1 sass_0.4.10          
    ##  [94] digest_0.6.39         ggrepel_0.9.7         FactoMineR_2.13      
    ##  [97] htmlwidgets_1.6.4     farver_2.1.2          htmltools_0.5.9      
    ## [100] pkgdown_2.2.0         lifecycle_1.0.5       multcompView_0.1-11  
    ## [103] MASS_7.3-65
